...
export function MovieCard(props: movieSchema) {
    ...
    return (
        <article className="w-64 h-84 bg-[#f1f1f1] p-0.5 m-1 rounded-md hover:scale-105 transition duration-300 font-mono">
            <img src={props.poster} className="w-full h-64 hover:scale-90 transition duration-300 hover:blur-[2px]" alt="poster of the film" />
